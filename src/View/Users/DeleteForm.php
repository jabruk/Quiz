...
class DeleteForm extends \Quiz\View\Main
{
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <div class="alert alert-danger alert-dismissable">
                                        ...
                                        <p>Are you sure you want to delete the user? <a class="alert-link" href="javascript:void(0)"><?=  $data['user']['name'] ?></a>?</p>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
                                    ...
                                    <a class="btn btn-sm btn-primary" href="<?= $data['url']['cancel'] ?>">Cancel</a>
                                </div>
                            </div>
                        </form>
                    </div>
